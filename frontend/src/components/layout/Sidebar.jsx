...
const navItems = [
  ...
  {
    path: '/carburant', label: 'Carburant',
    roles: ['CONDUCTEUR', 'GESTIONNAIRE', 'ADMIN'],
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 21V5a2 2 0 012-2h6a2 2 0 012 2v16M3 21h10M3 10h10m4-4l2.5 2.5M19 8.5V17a2 2 0 002 2 2 2 0 002-2V9.5a1 1 0 00-.293-.707L19 5" /></svg>,
  },
  {
